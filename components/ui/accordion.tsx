...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("border px-4 bg-gray-50", className)}
      {...props}
    />
  )
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="text-muted-foreground pointer-events-none size-7 shrink-0 translate-y-3 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
