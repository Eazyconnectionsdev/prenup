      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <input
            id="partner-mobile"
            type="tel"
            value={partnerData.mobileNumber || partnerData.phone || ''}
            onChange={(e) => onChange({ mobileNumber: e.target.value, phone: e.target.value })}
        ...
        <div className="space-y-2">
          ...
          <input
            id="target-date"
            type="date"
            value={partnerData.targetWeddingDate || partnerData.targetDate || ''}
            onChange={(e) => onChange({ targetWeddingDate: e.target.value, targetDate: e.target.value })}
