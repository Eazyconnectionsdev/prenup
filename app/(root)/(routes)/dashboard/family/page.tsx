...
function RadioCard({
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-[0.925rem] font-semibold transition ${checked ? "text-indigo-600" : "text-slate-900"}`}
      >
        {label}
      </span>
    </label>
...
export default function FamilyDependentsForm() {
  ...
  const showSeparationWarning =
    showSeparationCheckbox && formData.isLegallySeparated;
  ...
  const handlePriorMarriageChange = (value: PriorMarriageStatus) => {
    setFormData((prev) => ({
      ...
      isLegallySeparated:
        value === "Yes, previously divorced" ? prev.isLegallySeparated : false,
    }));
  };
  ...
  const updateChildRow = <K extends keyof ChildRow>(
    id: string,
    key: K,
    value: ChildRow[K],
  ) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const { data } = await Axios.post(
        `/cases/${caseId}/questionnaire/${user.endUserType === "user1" ? "family-and-dependents" : "partner-family-and-dependents"}`,
        payload,
      );
            ...
            <div className="mb-7">
              ...
              <div className="mb-2.5 grid grid-cols-1 gap-3 sm:grid-cols-3">
                <RadioCard
                  ...
                  onChange={() =>
                    handlePriorMarriageChange("No, never married")
                  }
                />
                <RadioCard
                  id="pm_divorced"
                  ...
                  onChange={() =>
                    handlePriorMarriageChange("Yes, previously divorced")
                  }
                />
                <RadioCard
                  id="pm_widowed"
                  ...
                  <label className="flex cursor-pointer items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          isLegallySeparated: e.target.checked,
                        }))
                      }
              ...
              {showSeparationWarning && (
                <div className="mt-3.5 rounded-[10px] border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-700">
                  <strong>⚠️ Important Timeline Note:</strong> You can continue
                  completing your questionnaire. However, your prenuptial
                  agreement cannot usually be finalised until your previous
                  divorce has been legally completed. Your independent solicitor
                  will advise you on the appropriate timing.
                </div>
              )}
            </div>
                  ...
                  {children.map((child) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          updateChildRow(child.id, "fullName", e.target.value)
                        }
                        required
                      ...
                      <input
                        ...
                        value={child.dob}
                        onChange={(e) =>
                          updateChildRow(child.id, "dob", e.target.value)
                        }
                        required
                        className={inputClasses}
                      />
            ...
            <div className="mb-7">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    futureParentalIntentions: e.target
                      .value as ParentalIntention,
                  }))
                }
                required
                className={inputClasses}
            ...
            <div className="mb-7">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <RadioCard
                  ...
                  onChange={() =>
                    setFormData((prev) => ({ ...prev, hasFamilyPets: "Yes" }))
                  }
                />
                <RadioCard
                  id="pets_no"
                  ...
                  onChange={() =>
                    setFormData((prev) => ({ ...prev, hasFamilyPets: "No" }))
                  }
                />
              </div>
            </div>
