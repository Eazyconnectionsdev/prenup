...
export default function LawyerProfiles() {
  ...
  const handleConnect = (e: React.MouseEvent, id: number) => {
    e.stopPropagation();
    // mark selected (you can change to toggle if you want to allow unselect)
    setSelectedId(id);
  };
  ...
  return (
    <section className="py-12 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="mt-6 text-4xl text-center font-serif text-slate-900">Lawyer Profiles</h2>
        ...
        <div className="mt-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {lawyers.map((lawyer) => {
              ...
              return (
                <article
                  key={lawyer.id}
                  // visually disabled look when selected
                ...
                >
                  ...
                  <div className="mt-4 text-center">
                    <h3 className={`text-lg font-semibold text-slate-900 ${isSelected ? "line-through" : ""}`}>{lawyer.name}</h3>
                    ...
                    <button
                      ...
                      // keep this interactive only if not selected
                    ...
                    <div className="mt-4">
                      {/* Use your Button component or a styled div. Here Button receives disabled prop. */}
                      <Button
          ...
          <div className="mt-8 text-center text-slate-600">Showing {lawyers.length} lawyers</div>
        </div>
      </div>
    </section>
  );
